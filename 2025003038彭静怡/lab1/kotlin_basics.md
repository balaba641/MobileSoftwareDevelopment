...
```kotlin
fun main() {
	println("My name is pengjingyi")
    println("My student ID is 2025003038")
...
```kotlin
fun main() {
    println("Student 2025003038 says hello")
}
```
...
```kotlin
fun main() {
    println("Hello, my name is pengjinyi")
}
```
...
```kotlin
fun main() {
    println("ID: 2025003038") 
    println("Name: pengjingyi") 
...
```kotlin
fun main() {
    val pengjingyi = "2025003038"
    println("Package for pengjingyi will arrive, tracking ID:" + pengjingyi)
}
```
...
```kotlin
fun main() {
    printInfo(pengjingyi(age = 8))       
    printInfo(pengjingyi("pengjingyi", 3))   
}

fun pengjingyi(name: String = "2025003038", age: Int): String {
...
```kotlin
fun main() {
    printpengjingyiWeather("Ankara", 27, 31, 82)
    printpengjingyiWeather("Tokyo", 32, 36, 10)
    printprngjingyiWeather("Cape Town", 59, 64, 2)
    printpengjingyiWeather("Guatemala City", 50, 55, 7)
}

fun printpengjingyiWeather(cityName: String, lowTemp: Int, highTemp: Int, rainChance: Int) {
